...
SECRET_KEY = "django-insecure--#hss)qd6_5x4ud6bix&ev2ih&j3n@f$g1nx1qax^w4n8portl"
...
ROOT_URLCONF = "turismorealweb.urls"
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'departamentos.custom_context_processor.user_renderer'
            ],
        },
    },
]

WSGI_APPLICATION = "turismorealweb.wsgi.application"
