...
var HotelDatepicker = function() {
    ...
    function s(e, t) {
        ...
        this.topbarPosition = "bottom" === t.topbarPosition ? "bottom" : "top",
        ...
        this.submitButtonName = this.submitButton && t.submitButtonName ? t.submitButtonName : "",
        this.i18n = t.i18n || {
            selected: "Your stay:",
            night: "Night",
            nights: "Nights",
        ...
        this.onOpenDatepicker = void 0 !== t.onOpenDatepicker && t.onOpenDatepicker,
        this.onSelectRange = void 0 !== t.onSelectRange && t.onSelectRange,
        this.input = e,
        this.init()
    }
    var t = 0;
    ...
    s.prototype.init = function() {
        ...
        this.endDate && 0 < this.compareMonth(this.getNextMonth(t), this.endDate) && (t = new Date(this.getPrevMonth(this.endDate.getTime()))),
        ...
        this.clearButton && (document.getElementById(this.getClearButtonId()).disabled = !0),
    ...
    s.prototype.createDatepickerDomString = function() {
        var t = this.inline ? " datepicker--inline" : ""
          , e = (this.showTopbar && "bottom" === this.topbarPosition && (t += " datepicker--topbar-bottom"),
        ...
        "");
        this.showTopbar && (e += '<div class="datepicker__topbar"><div class="datepicker__info datepicker__info--selected"><span class="datepicker__info datepicker__info--selected-label">' + this.lang("selected") + ' </span> <strong class="datepicker__info-text datepicker__info-text--start-day">...</strong> <span class="datepicker__info-text datepicker__info--separator">' + this.separator + '</span> <strong class="datepicker__info-text datepicker__info-text--end-day">...</strong> <em class="datepicker__info-text datepicker__info-text--selected-days">(<span></span>)</em></div><div class="datepicker__info datepicker__info--feedback"></div>',
        this.inline || (e += '<button type="button" id="' + this.getCloseButtonId() + '" class="datepicker__close-button">' + this.lang("button") + "</button>"),
        (this.clearButton || this.submitButton) && (e += '<div class="datepicker__buttons">'),
        this.clearButton && (e += '<button type="button" id="' + this.getClearButtonId() + '" class="datepicker__clear-button">' + this.lang("clearButton") + "</button>"),
        this.submitButton && (e += '<input type="submit" id="' + this.getSubmitButtonId() + '" class="datepicker__submit-button" value="' + this.lang("submitButton") + '" name="' + this.submitButtonName + '">'),
        ...
        s = (s += '<div style="display:none" id="' + this.getTooltipId() + '" class="datepicker__tooltip"></div>') + "</div>" + "</div>"
    }
    ,
    ...
    s.prototype.createMonthDomString = function(t) {
        ...
        if (0 < (a = 0 === a && "monday" === this.startOfWeek ? 7 : a))
            for (var o = a; 0 < o; o--) {
                ...
                (e.startDate && e.compareDay(h, e.startDate) < 0 || e.endDate && 0 < e.compareDay(h, e.endDate)) && (r = !1),
                s.push({
                    date: h,
                    type: "lastMonth",
                    day: h.getDate(),
        ...
        for (var d = 0; d < 40; d++) {
            ...
            (e.startDate && e.compareDay(l, e.startDate) < 0 || e.endDate && 0 < e.compareDay(l, e.endDate)) && (r = !1),
            s.push({
                date: l,
        ...
        for (var c = 0; c < 6 && "nextMonth" !== s[7 * c].type; c++) {
            ...
            for (var p = 0; p < 7; p++) {
                var m = s[7 * c + ("monday" === e.startOfWeek ? p + 1 : p)]
                  , u = e.getDayClasses(m)
                  , y = ""
                  , u = (e.hasClass(m, "datepicker__month-day--no-checkin") && (y = e.i18n["checkin-disabled"]),
                e.hasClass(m, "datepicker__month-day--no-checkout") && (y && (y += ". "),
                ...
                y && (u.title = y),
                i += '<td class="' + u.class + '" ' + e.printAttributes(u) + ">" + m.day + "</td>"
            }
            i += "</tr>"
        }
        return i
    ...
    s.prototype.getDayClasses = function(t) {
        var e, s, i, a = this.getDateString(t.time) === this.getDateString(new Date), n = this.getDateString(t.time) === this.getDateString(this.startDate), o = !1, h = !1, r = !1, d = !1, l = !1, c = !1;
        return !t.valid && "visibleMonth" !== t.type || (e = this.getDateString(t.time, "YYYY-MM-DD"),
        0 < this.disabledDates.length && ((i = this.getClosestDisabledDates(t.date))[0] && i[1] && this.compareDay(t.date, i[0]) && 0 < this.countDays(i[0], i[1]) - 2 && (s = this.countDays(i[1], t.date) - 1,
        i = this.countDays(t.date, i[0]) - 1,
        (this.selectForward && s < this.minDays || !this.selectForward && s < this.minDays && i < this.minDays) && (t.valid = !1),
        !t.valid && this.enableCheckout && 2 == s && (c = !0)),
        -1 < this.disabledDates.indexOf(e) ? (o = !(t.valid = !1),
        this.isFirstDisabledDate++,
        this.lastDisabledDate = t.date) : this.isFirstDisabledDate = 0,
        t.valid && this.lastDisabledDate && 0 < this.compareDay(t.date, this.lastDisabledDate) && 2 === this.countDays(t.date, this.lastDisabledDate) && (l = !0)),
        0 < this.disabledDaysOfWeek.length && -1 < this.disabledDaysOfWeek.indexOf(fecha.format(t.time, "dddd")) && (d = !(t.valid = !1)),
        0 < this.noCheckInDates.length && -1 < this.noCheckInDates.indexOf(e) && (l = !(h = !0)),
        0 < this.noCheckOutDates.length && -1 < this.noCheckOutDates.indexOf(e) && (r = !0),
        0 < this.noCheckInDaysOfWeek.length && -1 < this.noCheckInDaysOfWeek.indexOf(fecha.format(t.time, "dddd")) && (l = !(h = !0)),
        0 < this.noCheckOutDaysOfWeek.length && -1 < this.noCheckOutDaysOfWeek.indexOf(fecha.format(t.time, "dddd")) && (r = !0)),
        ["datepicker__month-day", "datepicker__month-day--" + t.type, "datepicker__month-day--" + (t.valid ? "valid" : "invalid"), a ? "datepicker__month-day--today" : "", o ? "datepicker__month-day--disabled" : "", o && this.enableCheckout && 1 === this.isFirstDisabledDate ? "datepicker__month-day--checkout-enabled" : "", c ? "datepicker__month-day--before-disabled-date" : "", n || l ? "datepicker__month-day--checkin-only" : "", h ? "datepicker__month-day--no-checkin" : "", r ? "datepicker__month-day--no-checkout" : "", d ? "datepicker__month-day--day-of-week-disabled" : ""]
    }
    ,
    s.prototype.checkAndSetDayClasses = function() {
        for (var t = this, e = this.datepicker.getElementsByTagName("td"), s = 0; s < e.length; s++) {
            var i = parseInt(e[s].getAttribute("time"), 10)
              , a = new Date(i)
              , n = e[s].getAttribute("daytype")
              , o = void 0
              , o = t.isValidDate(a.getTime())
              , n = ((t.startDate && t.compareDay(a, t.startDate) < 0 || t.endDate && 0 < t.compareDay(a, t.endDate)) && (o = !1),
            {
                date: a,
                type: n,
                day: a.getDate(),
    ...
    s.prototype.checkAndSetDefaultValue = function(t) {
        void 0 === t && (t = !1);
        var e, s = this.getValue(), s = s ? s.split(this.separator) : "";
        s && 2 <= s.length ? (e = this.format,
        this.changed = !1,
        this.setDateRange(this.parseDate(s[0], e), this.parseDate(s[1], e), t),
        this.changed = !0) : this.showTopbar && (this.datepicker.getElementsByClassName("datepicker__info--selected")[0].style.display = "none",
        t && (s = new Date,
        this.startDate && this.compareMonth(s, this.startDate) < 0 && (s = new Date(this.startDate.getTime())),
        this.endDate && 0 < this.compareMonth(this.getNextMonth(s), this.endDate) && (s = new Date(this.getPrevMonth(this.endDate.getTime()))),
    ...
    s.prototype.setDateRange = function(t, e, s) {
        void 0 === s && (s = !1),
        t.getTime() > e.getTime() && (i = e,
        e = t,
        t = i,
        i = null);
        var i = !0;
        if (!(i = this.startDate && this.compareDay(t, this.startDate) < 0 || this.endDate && 0 < this.compareDay(e, this.endDate) ? !1 : i))
            return this.showMonth(this.startDate, 1),
        ...
        this.end = e.getTime(),
        0 < this.compareDay(t, e) && 0 === this.compareMonth(t, e) && (e = this.getNextMonth(t)),
    ...
    s.prototype.showSelectedDays = function() {
        ...
        if (this.start || this.end)
            for (var e = this.datepicker.getElementsByTagName("td"), s = 0; s < e.length; s++) {
                var i = parseInt(e[s].getAttribute("time"), 10);
                t.start && t.end && t.end >= i && t.start <= i || t.start && !t.end && t.getDateString(t.start, "YYYY-MM-DD") === t.getDateString(i, "YYYY-MM-DD") ? t.addClass(e[s], "datepicker__month-day--selected") : t.removeClass(e[s], "datepicker__month-day--selected"),
                t.start && t.getDateString(t.start, "YYYY-MM-DD") === t.getDateString(i, "YYYY-MM-DD") ? t.addClass(e[s], "datepicker__month-day--first-day-selected") : t.removeClass(e[s], "datepicker__month-day--first-day-selected"),
                t.end && t.getDateString(t.end, "YYYY-MM-DD") === t.getDateString(i, "YYYY-MM-DD") ? t.addClass(e[s], "datepicker__month-day--last-day-selected") : t.removeClass(e[s], "datepicker__month-day--last-day-selected")
            }
    }
    ,
    s.prototype.showSelectedInfo = function() {
        var t, e, s, i, a, n, o;
        this.showTopbar ? (n = (a = this.datepicker.getElementsByClassName("datepicker__info--selected")[0]).getElementsByClassName("datepicker__info-text--start-day")[0],
        o = a.getElementsByClassName("datepicker__info-text--end-day")[0],
        t = a.getElementsByClassName("datepicker__info-text--selected-days")[0],
        ...
        this.start && (a.style.display = "",
        n.textContent = this.getDateString(new Date(parseInt(this.start, 10)), this.infoFormat),
        this.inline && this.clearButton && (s.disabled = !1)),
        this.end && (o.textContent = this.getDateString(new Date(parseInt(this.end, 10)), this.infoFormat)),
        this.start && this.end ? (n = 1 == (a = this.countDays(this.end, this.start) - 1) ? a + " " + this.lang("night") : a + " " + this.lang("nights"),
        o = this.getDateString(new Date(this.start)) + this.separator + this.getDateString(new Date(this.end)),
        t.style.display = "",
        t.firstElementChild.textContent = n,
        this.inline ? this.submitButton && (i.disabled = !1) : e.disabled = !1,
        this.setValue(o, this.getDateString(new Date(this.start)), this.getDateString(new Date(this.end))),
        this.changed = !0) : this.inline ? (!this.clearButton || this.start || this.end || (s.disabled = !0),
        this.submitButton && (i.disabled = !0)) : e.disabled = !0) : this.start && this.end && (a = this.getDateString(new Date(this.start)) + this.separator + this.getDateString(new Date(this.end)),
        this.setValue(a, this.getDateString(new Date(this.start)), this.getDateString(new Date(this.end))),
        this.changed = !0)
    }
    ,
    s.prototype.dayClicked = function(t) {
        if (!this.hasClass(t, "datepicker__month-day--invalid")) {
            ...
            if (e) {
                ...
                if (this.start > s && this.hasClass(t, "datepicker__month-day--no-checkin"))
                    return;
                var i = this.datepicker.querySelectorAll('td[time="' + this.start + '"]')[0];
                if (i && this.hasClass(i, "datepicker__month-day--no-checkout") && this.start > s)
                    return;
                if (this.hasClass(t, "datepicker__month-day--no-checkout") && s > this.start)
                    return
            }
            this.addClass(t, "datepicker__month-day--selected"),
            e ? (this.start = s,
            this.end = !1) : this.start && (this.end = s),
            this.start && this.end && this.start > this.end && (i = this.end,
            this.end = this.start,
            this.start = i),
    ...
    s.prototype.isValidDate = function(t) {
        if (t = parseInt(t, 10),
        this.startDate && this.compareDay(t, this.startDate) < 0 || this.endDate && 0 < this.compareDay(t, this.endDate))
            return !1;
        if (this.start && !this.end) {
            if (0 < this.maxDays && this.countDays(t, this.start) > this.maxDays || 0 < this.minDays && 1 < this.countDays(t, this.start) && this.countDays(t, this.start) < this.minDays)
                return !1;
            if (this.selectForward && t < this.start)
                return !1;
            if (0 < this.disabledDates.length) {
                var e = this.getClosestDisabledDates(new Date(parseInt(this.start, 10)));
                if (e[0] && this.compareDay(t, e[0]) <= 0)
                    return !1;
                if (e[1] && 0 <= this.compareDay(t, e[1]))
                    return !1
            }
            if (0 < this.disabledDaysOfWeek.length) {
                e = this.getClosestDisabledDays(new Date(parseInt(this.start, 10)));
                if (e[0] && this.compareDay(t, e[0]) <= 0)
                    return !1;
                if (e[1] && 0 <= this.compareDay(t, e[1]))
                    return !1
    ...
    s.prototype.checkSelection = function() {
        ...
        if (this.maxDays && e > this.maxDays) {
            ...
            for (var i = this.datepicker.getElementsByTagName("td"), a = 0; a < i.length; a++)
                ...
                t.removeClass(i[a], "datepicker__month-day--first-day-selected"),
                t.removeClass(i[a], "datepicker__month-day--last-day-selected");
            this.showTopbar && (n = this.maxDays - 1,
            this.topBarErrorText(s, "error-more", n))
        } else if (this.minDays && e < this.minDays) {
            this.start = !1,
            this.end = !1;
            for (var n, o = this.datepicker.getElementsByTagName("td"), h = 0; h < o.length; h++)
                t.removeClass(o[h], "datepicker__month-day--selected"),
                t.removeClass(o[h], "datepicker__month-day--first-day-selected"),
                t.removeClass(o[h], "datepicker__month-day--last-day-selected");
            this.showTopbar && (n = this.minDays - 1,
            this.topBarErrorText(s, "error-less", n))
        } else
            this.start || this.end ? this.showTopbar && (this.removeClass(s, "datepicker__info--error"),
            this.removeClass(s, "datepicker__info--help")) : this.showTopbar && (this.removeClass(s, "datepicker__info--error"),
    ...
    s.prototype.toLocalTimestamp = function(t) {
        return "string" != typeof (t = "object" == typeof t && t.getTime ? t.getTime() : t) || t.match(/\d{13}/) || (t = this.parseDate(t).getTime()),
    ...
    s.prototype.goToNextMonth = function(t) {
        ...
        !this.isSingleMonth() && !e && 0 <= this.compareMonth(s, this.month2) || this.isMonthOutOfRange(s) || (this.moveBothMonths && e && this.showMonth(this.month2, 1),
        this.showMonth(s, t),
        this.showSelectedDays(),
        this.disableNextPrevButtons())
    }
    ...
    s.prototype.goToPreviousMonth = function(t) {
        ...
        e && this.compareMonth(s, this.month1) <= 0 || this.isMonthOutOfRange(s) || (this.moveBothMonths && !e && this.showMonth(this.month1, 2),
        this.showMonth(s, t),
        this.showSelectedDays(),
        this.disableNextPrevButtons())
    }
    ...
    s.prototype.disableNextPrevButtons = function() {
        var t, e, s;
        this.isSingleMonth() || (t = parseInt(this.getDateString(this.month1, "YYYYMM"), 10),
        e = parseInt(this.getDateString(this.month2, "YYYYMM"), 10),
        t = Math.abs(t - e),
        e = this.datepicker.getElementsByClassName("datepicker__month-button--next"),
        s = this.datepicker.getElementsByClassName("datepicker__month-button--prev"),
        1 < t && 89 !== t ? (this.removeClass(e[0], "datepicker__month-button--disabled"),
        this.removeClass(s[1], "datepicker__month-button--disabled")) : (this.addClass(e[0], "datepicker__month-button--disabled"),
        this.addClass(s[1], "datepicker__month-button--disabled")),
        this.isMonthOutOfRange(this.getPrevMonth(this.month1)) ? this.addClass(s[0], "datepicker__month-button--disabled") : this.removeClass(s[0], "datepicker__month-button--disabled"),
        this.isMonthOutOfRange(this.getNextMonth(this.month2)) ? this.addClass(e[1], "datepicker__month-button--disabled") : this.removeClass(e[1], "datepicker__month-button--disabled"))
    }
    ,
    s.prototype.topBarDefaultText = function() {
        var t, e;
        this.showTopbar && (t = "",
        t = this.minDays && this.maxDays ? this.minDays === this.maxDays ? this.lang("info-range-equal") : this.lang("info-range") : this.minDays && 2 < this.minDays ? this.lang("info-more-plural") : this.minDays ? this.lang("info-more") : this.lang("info-default"),
        e = this.datepicker.getElementsByClassName("datepicker__info--feedback")[0],
    ...
    s.prototype.topBarErrorText = function(t, e, s) {
        this.showTopbar && (this.addClass(t, "datepicker__info--error"),
        this.removeClass(t, "datepicker__info--help"),
        1 < s ? (e = (e = this.lang(e + "-plural")).replace("%d", s),
        t.textContent = e) : e = this.lang(e),
    ...
    s.prototype.updateSelectableRange = function() {
        for (var t, e = this, s = this.datepicker.getElementsByTagName("td"), i = this.start && !this.end, a = 0; a < s.length; a++)
            e.hasClass(s[a], "datepicker__month-day--invalid") && e.hasClass(s[a], "datepicker__month-day--tmp") && (e.removeClass(s[a], "datepicker__month-day--tmp"),
            e.hasClass(s[a], "datepicker__month-day--tmpinvalid") ? e.removeClass(s[a], "datepicker__month-day--tmpinvalid") : (e.removeClass(s[a], "datepicker__month-day--invalid"),
            e.addClass(s[a], "datepicker__month-day--valid"))),
            i ? e.hasClass(s[a], "datepicker__month-day--visibleMonth") && (e.hasClass(s[a], "datepicker__month-day--valid") || e.hasClass(s[a], "datepicker__month-day--disabled") || e.hasClass(s[a], "datepicker__month-day--before-disabled-date")) && (t = parseInt(s[a].getAttribute("time"), 10),
            e.isValidDate(t) ? (e.addClass(s[a], "datepicker__month-day--valid"),
            e.addClass(s[a], "datepicker__month-day--tmp"),
            e.removeClass(s[a], "datepicker__month-day--invalid"),
            e.removeClass(s[a], "datepicker__month-day--disabled")) : (e.hasClass(s[a], "datepicker__month-day--invalid") && e.addClass(s[a], "datepicker__month-day--tmpinvalid"),
            e.addClass(s[a], "datepicker__month-day--invalid"),
            e.addClass(s[a], "datepicker__month-day--tmp"),
            e.removeClass(s[a], "datepicker__month-day--valid"))) : (e.hasClass(s[a], "datepicker__month-day--checkout-enabled") || e.hasClass(s[a], "datepicker__month-day--before-disabled-date")) && (e.addClass(s[a], "datepicker__month-day--invalid"),
            e.removeClass(s[a], "datepicker__month-day--valid"),
            e.hasClass(s[a], "datepicker__month-day--before-disabled-date") || e.addClass(s[a], "datepicker__month-day--disabled"));
        return !0
    }
    ,
    s.prototype.dayHovering = function(t) {
        var e, s, i, a = this, n = parseInt(t.getAttribute("time"), 10), o = "";
        if (!this.hasClass(t, "datepicker__month-day--invalid")) {
            for (var h, r = this.datepicker.getElementsByTagName("td"), d = 0; d < r.length; d++) {
                var l = parseInt(r[d].getAttribute("time"), 10);
                l === n ? a.addClass(r[d], "datepicker__month-day--hovering") : a.removeClass(r[d], "datepicker__month-day--hovering"),
                a.start && !a.end && (a.start < l && l <= n || a.start > l && n <= l) ? a.addClass(r[d], "datepicker__month-day--hovering") : a.removeClass(r[d], "datepicker__month-day--hovering")
            }
            this.start && !this.end && (h = this.countDays(n, this.start) - 1,
            this.hoveringTooltip && ("function" == typeof this.hoveringTooltip ? o = this.hoveringTooltip(h, this.start, n) : !0 === this.hoveringTooltip && 0 < h && (o = h + " " + (1 == h ? this.lang("night") : this.lang("nights")))))
        }
        ...
        s = h.top - t.top,
        e += h.width / 2,
        (i = document.getElementById(this.getTooltipId())).style.display = "",
        i.textContent = o,
    ...
    s.prototype.getClosestDisabledDates = function(t) {
        ...
        if (t < this.disabledDatesTime[0])
            ...
            for (var s, i = this.disabledDatesTime.length, a = this.disabledDatesTime.length, n = Math.abs(new Date(0,0,0).valueOf()), o = n, h = -n, r = 0; r < this.disabledDatesTime.length; ++r)
                (s = t - this.disabledDatesTime[r]) < 0 && h < s && (a = r,
                h = s),
                0 < s && s < o && (i = r,
                o = s);
            this.disabledDatesTime[i] && (e[0] = this.disabledDatesTime[i]),
            void 0 === this.disabledDatesTime[i] ? e[1] = !1 : this.enableCheckout ? e[1] = this.addDays(this.disabledDatesTime[a], 1) : e[1] = this.disabledDatesTime[a]
        }
        return e
    }
    ,
    ...
    s.prototype.setRange = function(t, e) {
        "string" == typeof t && "string" == typeof e && (t = this.parseDate(t),
        e = this.parseDate(e)),
    ...
    s.prototype.getNights = function() {
        var t, e, s = 0;
        return this.start && this.end ? s = this.countDays(this.end, this.start) - 1 : (t = (t = this.getValue()) ? t.split(this.separator) : "") && 2 <= t.length && (e = this.format,
        s = this.countDays(this.parseDate(t[0], e), this.parseDate(t[1], e)) - 1),
        s
    }
    ,
