!function(t, n) {
    ...
    function w(t, e, o) {
        ...
        for (var H = new Date(u.year,u.month,u.day,u.hour,u.minute,u.second,u.millisecond), b = [["month", "getMonth"], ["day", "getDate"], ["hour", "getHours"], ["minute", "getMinutes"], ["second", "getSeconds"]], w = (M = 0,
        b.length); M < w; M++)
            if (f[b[M][0]] && u[b[M][0]] !== H[b[M][1]]())
                return null;
